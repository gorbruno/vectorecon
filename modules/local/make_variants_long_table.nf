process MAKE_VARIANTS_LONG_TABLE {
    ...
    conda "conda-forge::python=3.12.8 conda-forge::matplotlib=3.10.0 conda-forge::pandas=2.2.3 conda-forge::r-sys=3.4.3 conda-forge::regex=2024.11.6 conda-forge::scipy=1.15.1"
